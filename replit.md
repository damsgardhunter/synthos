...
- **Universal stoichiometry cap**: Max 12 per element, max 20 total atoms. Enforced in `countsToFormula` (hard cap), `passesValenceFilter`, `passesCompositionComplexityFilter`, `passesElementCountCap`, RL agent candidate acceptance, and inverse generator `buildFormula`. Fullerene seeds (K3C60 etc.) and high-atom seeds (UBe13, Ca10Pt4As8, Bi2Sr2CaCu2O8) removed.

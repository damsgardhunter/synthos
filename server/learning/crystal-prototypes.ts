...
const IONIC_RADII: Record<string, number> = {
  ...
  Nb: 0.64, Mo: 0.59, Ru: 0.62, Rh: 0.60, Pd: 0.86, Ag: 1.15, Cd: 0.95,
  In: 0.80, Sn: 0.69, Sb: 0.76, Te: 2.21, I: 2.20, Cs: 1.67, Ba: 1.35,
  La: 1.03, Ce: 1.01, Pr: 0.99, Nd: 0.98, Sm: 0.96, Gd: 0.94,
  Hf: 0.71, Ta: 0.64, W: 0.60, Re: 0.53, Os: 0.55, Ir: 0.57, Pt: 0.63,
...
const OXIDATION_STATES: Record<string, number[]> = {
  ...
  Ti: [4, 3], Zr: [4], Hf: [4], V: [5, 4, 3], Nb: [5, 3], Ta: [5],
  ...
  N: [-3, 5], P: [-3, 5], As: [-3, 5], Sb: [-3, 5], Bi: [3],
  O: [-2], S: [-2, 6], Se: [-2], Te: [-2],
  F: [-1], Cl: [-1], Br: [-1], I: [-1],
};

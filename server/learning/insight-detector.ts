...
const WELL_KNOWN_PATTERNS = [
  ...
  "more negative formation energy correlates with higher stability",
  "more negative formation energy predicts greater stability",
  "higher stability correlates with more negative formation energy",
  "formation energy predicts stability",
  "stability predicted by formation energy",
  "lower formation energy predicts more stable",
  "band gap below 0.5 ev predict higher thermodynamic stability",
  "band gap predicts thermodynamic stability in hydrides",
  "materials with band gap correlates with thermodynamic stability",
